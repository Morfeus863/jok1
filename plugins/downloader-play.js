...
❏ 🔗 *Ссылка:* ${yt_play[0].url}`.trim();
    ...
    try {
      ...
      const buttonMessage = {
        image: { url: thumbnail },
        caption: capt,
        footer: "*Ищем и скачиваем ваше аудио,одну минуточку...*",
        buttons: buttons,
        headerType: 4,
      };

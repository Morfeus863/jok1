...
user.warn -= 1
await conn.sendButton(m.chat,`${user.warn == 1 ? `*@${who.split`@`[0]}*` : `♻️ *@${who.split`@`[0]}*`} С вас снято нарушение `, `*Предупреждений:*\n⚠️ *Было: ${user.warn + 1}/3*\n⚠️ *Стало: ${user.warn}/3*\n\n${wm}`, pp, [['📋 ССПИСОК НАРУШИТЕЛЕЙ 📋', '#listwarn']], m, { mentions: [who] })}

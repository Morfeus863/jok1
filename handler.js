...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        owner: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА МОЖЕТ ИСПОЛЬЗОВАТЬСЯ ТОЛЬКО ВЛАДЕЛЬЦЕМ БОТА*',
        mods: '*[ ⚠️ ВНИМАНИЕ ⚠️ ] ЭТА КОМАНДА МОЖЕТ ИСПОЛЬЗОВАТЬСЯ ТОЛЬКО ВЛАДЕЛЬЦЕМ БОТА*',
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] ВНИМАНИЕ', body: 'JoKeR', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/FQ4gui0wUTO94zgP2YUbsH' }}}}, aa)
